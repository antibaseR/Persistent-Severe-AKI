...
# setting
analysis="_pAKI_at_first_encounter_method1.2_unadjusted"
...
for (i in 1:length(impDat)){
  ...
  if(analysis == "_pAKI_at_first_encounter_method1.2" | analysis == "_pAKI_at_first_encounter_method1.2_unadjusted"){
    data = data %>%
...
beta_df$variable_true = c("Persistent AKI at the first encounter: yes")

beta_df$hazard_ratio = exp(beta_df$beta_bar)

order =  c("Persistent AKI at the first encounter: yes")
