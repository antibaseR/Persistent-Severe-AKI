...
# setting
analysis="_pAKI_at_first_encounter_method1.2_pAKIonly"
#analysis="_pAKI_at_first_encounter_method1.2_pAKIonly_sensitivity"
...
for (i in 1:length(impDat)){
  ...
  if(analysis == "_pAKI_at_first_encounter_method1.2_pAKIonly"){
    data = data %>%
  ...
  #set.seed(960725)
  #obj = rfsrc(Surv(pAKI_time, pAKI_90) ~ ., coxdata,
  #            ntree = 1, nodesize = 5, nsplit = 10, importance = TRUE)
  #tree = get.tree(obj, 1)
  #tree
  
  cox_fit = coxph(Surv(pAKI_time, pAKI_90) ~ ., data=coxdata)
