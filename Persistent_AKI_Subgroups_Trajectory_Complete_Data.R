...
for (i in 1:length(impDat)){
  ...
  freq_table = freq_table %>%
    mutate(day1_kidgo = factor(day1_kidgo, levels=c(paste(c(0,1,2,3)))),
           day2_kidgo = factor(day2_kidgo, levels=c(paste(c(0,1,2,3)))),
           day3_kidgo = factor(day3_kidgo, levels=c(paste(c(0,1,2,3)))),
           day4_kidgo = factor(day4_kidgo, levels=c(paste(c(0,1,2,3)))),
           day5_kidgo = factor(day5_kidgo, levels=c(paste(c(0,1,2,3)))),
           day6_kidgo = factor(day6_kidgo, levels=c(paste(c(0,1,2,3)))),
           day7_kidgo = factor(day7_kidgo, levels=c(paste(c(0,1,2,3)))))
  ...
  freq_table %>%
    ...
    labs(x = "Worst daily KDIGO stages after AKI diagnosis", y = "Frequency", fill = "AKI Category") +
    theme_bw()
