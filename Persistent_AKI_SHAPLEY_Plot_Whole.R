...
for (analysis in c("", "_sensitivity")){
  ...
  ggsave(paste("G:/Persistent_AKI/Xinlei/Result/SHAPLEY_with_therapy/shap_plot", analysis, ".png", sep=""), height=10, width=10)
  ...
  ggsave(paste("G:/Persistent_AKI/Xinlei/Result/SHAPLEY_with_therapy/shap_bar_plot", analysis, ".png", sep=""), height=10, width=10)
...
for (analysis in c("_ageq", "_ageq_sensitivity")){
  ...
  for (j in 1:4){
    ...
    ggsave(paste("G:/Persistent_AKI/Xinlei/Result/SHAPLEY_with_therapy/shap_plot", analysis, "_", j, ".png", sep=""), height=10, width=10)
    ...
    ggsave(paste("G:/Persistent_AKI/Xinlei/Result/SHAPLEY_with_therapy/shap_bar_plot", analysis, "_", j, ".png", sep=""), height=10, width=10)
