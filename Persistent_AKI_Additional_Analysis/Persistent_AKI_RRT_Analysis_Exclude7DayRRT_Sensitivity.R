...
# setting
for (analysis in c("_90-Day_RRT_exclude_7day_RRT_sensitivity")){
  ...
  saveRDS(train_sum_list, paste("G:/Persistent_AKI/Xinlei/Persistent_AKI_Additional_Analysis/Data/train_sum_list", analysis, ".rds", sep=""))
  saveRDS(test_sum_list, paste("G:/Persistent_AKI/Xinlei/Persistent_AKI_Additional_Analysis/Data/test_sum_list", analysis, ".rds", sep=""))
  saveRDS(var_imp_list, paste("G:/Persistent_AKI/Xinlei/Persistent_AKI_Additional_Analysis/Data/var_imp_list", analysis, ".rds", sep=""))
  saveRDS(cart_mod_list, paste("G:/Persistent_AKI/Xinlei/Persistent_AKI_Additional_Analysis/Data/cart_mod_list", analysis, ".rds", sep=""))
  saveRDS(train_dat_list, paste("G:/Persistent_AKI/Xinlei/Persistent_AKI_Additional_Analysis/Data/train_dat_list", analysis, ".rds", sep=""))
  saveRDS(test_dat_list, paste("G:/Persistent_AKI/Xinlei/Persistent_AKI_Additional_Analysis/Data/test_dat_list", analysis, ".rds", sep=""))
  ...
  train_sum_list = readRDS(paste("G:/Persistent_AKI/Xinlei/Persistent_AKI_Additional_Analysis/Data/train_sum_list", analysis, ".rds", sep=""))
  ...
  var_imp_list = readRDS(paste("G:/Persistent_AKI/Xinlei/Persistent_AKI_Additional_Analysis/Data/var_imp_list", analysis, ".rds", sep=""))
  cart_mod_list = readRDS(paste("G:/Persistent_AKI/Xinlei/Persistent_AKI_Additional_Analysis/Data/cart_mod_list", analysis, ".rds", sep=""))
  train_dat_list = readRDS(paste("G:/Persistent_AKI/Xinlei/Persistent_AKI_Additional_Analysis/Data/train_dat_list", analysis, ".rds", sep=""))
  test_dat_list = readRDS(paste("G:/Persistent_AKI/Xinlei/Persistent_AKI_Additional_Analysis/Data/test_dat_list", analysis, ".rds", sep=""))
  ...
  write.csv(glm_res_df, paste("G:/Persistent_AKI/Xinlei/Persistent_AKI_Additional_Analysis/Result/glm_res_df", analysis, ".csv", sep = ""))
