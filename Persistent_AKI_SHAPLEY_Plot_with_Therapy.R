...
for (analysis in c("", "_sensitivity")){
  ...
  shap_val_list = list()
  shap_val_list[[1]] = readRDS(paste("G:/Persistent_AKI/Xinlei/Data/SHAPLEY_with_therapy/SHAP_df_1", analysis, ".rds", sep=""))
  shap_val_list[[2]] = readRDS(paste("G:/Persistent_AKI/Xinlei/Data/SHAPLEY_with_therapy/SHAP_df_2", analysis, ".rds", sep=""))
  shap_val_list[[3]] = readRDS(paste("G:/Persistent_AKI/Xinlei/Data/SHAPLEY_with_therapy/SHAP_df_3", analysis, ".rds", sep=""))
  shap_val_list[[4]] = readRDS(paste("G:/Persistent_AKI/Xinlei/Data/SHAPLEY_with_therapy/SHAP_df_4", analysis, ".rds", sep=""))
  shap_val_list[[5]] = readRDS(paste("G:/Persistent_AKI/Xinlei/Data/SHAPLEY_with_therapy/SHAP_df_5", analysis, ".rds", sep=""))
  saveRDS(shap_val_list, paste("G:/Persistent_AKI/Xinlei/Data/SHAPLEY_with_therapy/shap_val_list", analysis, ".rds", sep=""))
  ...
  shap_val_list = readRDS(paste("G:/Persistent_AKI/Xinlei/Data/SHAPLEY_with_therapy/shap_val_list", analysis, ".rds", sep=""))
  ...
  shap_top_features = shap_val_df %>%
    group_by(feature) %>%
    summarise(shap_feature = mean(phi)) %>%
  ...
  ggsave(paste("G:/Persistent_AKI/Xinlei/Result/SHAPLEY_with_therapy/shap_plot", analysis, ".png", sep=""), height=5, width=10)
  ...
  ggsave(paste("G:/Persistent_AKI/Xinlei/Result/SHAPLEY_with_therapy/shap_bar_plot", analysis, ".png", sep=""), height=5, width=10)
  ...
  write.csv(AUC_df, paste("G:/Persistent_AKI/Xinlei/Result/SHAPLEY_with_therapy/AUC_df", analysis, ".csv", sep=""))
}
...
for (analysis in c("_ageq", "_ageq_sensitivity")){
  ...
  for (j in 1:4){
    ...
    shap_val_list = list()
    shap_val_list[[1]] = readRDS(paste("G:/Persistent_AKI/Xinlei/Data/SHAPLEY_with_therapy/SHAP_df_1_", j, ".rds", sep=""))
    shap_val_list[[2]] = readRDS(paste("G:/Persistent_AKI/Xinlei/Data/SHAPLEY_with_therapy/SHAP_df_2_", j, ".rds", sep=""))
    shap_val_list[[3]] = readRDS(paste("G:/Persistent_AKI/Xinlei/Data/SHAPLEY_with_therapy/SHAP_df_3_", j, ".rds", sep=""))
    shap_val_list[[4]] = readRDS(paste("G:/Persistent_AKI/Xinlei/Data/SHAPLEY_with_therapy/SHAP_df_4_", j, ".rds", sep=""))
    shap_val_list[[5]] = readRDS(paste("G:/Persistent_AKI/Xinlei/Data/SHAPLEY_with_therapy/SHAP_df_5_", j, ".rds", sep=""))
    saveRDS(shap_val_list, paste("G:/Persistent_AKI/Xinlei/Data/SHAPLEY_with_therapy/shap_val_list", analysis, "_", j, ".rds", sep=""))
    ...
    ggsave(paste("G:/Persistent_AKI/Xinlei/Result/SHAPLEY_with_therapy/shap_plot", analysis, "_", j, ".png", sep=""), height=5, width=10)
    ...
    ggsave(paste("G:/Persistent_AKI/Xinlei/Result/SHAPLEY_with_therapy/shap_bar_plot", analysis, "_", j, ".png", sep=""), height=5, width=10)
    ...
    colnames(AUC_df) = c("LASSO Regression", "XGBoost", "Super Learner")
    write.csv(AUC_df, paste("G:/Persistent_AKI/Xinlei/Result/SHAPLEY_with_therapy/AUC_df", analysis, "_", j, ".csv", sep=""))
  }
}
