...
# setting
analysis="_intervention_survival"
#analysis="_intervention_survival_sensitivity"
...
for (i in 1:length(impDat)){
  ...
  if(analysis == "_intervention_survival" | analysis == "_intervention_survival_sensitivity"){
    data = data %>%
